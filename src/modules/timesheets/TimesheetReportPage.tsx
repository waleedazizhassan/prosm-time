...
// export mechanism: the browser's own native print-to-PDF over this
// print-formatted view satisfies "Printable and exportable as PDF"
// with no added dependency or placeholder pending service; the CSV
// button is a genuine client-built file, satisfying "also exportable
// as spreadsheet". Bundles everything §22 names for the Evidence Pack
// - approved attendance records, GPS validation summaries (the
// geofence exceptions list), camera evidence references, exception
