...
const BACKEND_ERROR_KEYS: Record<string, string> = {
  ...
  "END TIME MUST BE AFTER START TIME - OVERNIGHT SHIFTS CROSSING MIDNIGHT ARE NOT SUPPORTED YET, SPLIT INTO TWO SAME-DAY SHIFTS INSTEAD (E.G. 22:00-23:59 AND 00:00-06:00)": "shiftOvernightNotSupported",
