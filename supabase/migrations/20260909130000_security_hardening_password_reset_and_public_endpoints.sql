-- PROSM Time - Security Hardening phase (user-directed):
-- "Password Reset + Public Endpoint Protection". Server-side
-- enforcement only; no product flow, UI or architecture change.
--
